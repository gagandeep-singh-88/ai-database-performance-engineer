...
class PiiDetectorTest {
    ...
    private final PiiDetector detector =
            new PiiDetector(new PrivacyProperties(true, TOKEN, true, true));

    @Test
    void redactsEmailAddresses() {
        RedactionResult result = detector.redact("contact john.doe@example.com now");
        assertThat(result.text()).isEqualTo("contact " + TOKEN + " now");
    ...
    void redactsJwtBeforeGenericTokens() {
        ...
        assertThat(result.text()).doesNotContain("eyJ");
    ...
    void redactsBearerTokenPreservingKeyword() {
        ...
        assertThat(result.text()).isEqualTo("Authorization: Bearer " + TOKEN);
    ...
    void redactsKeyValueSecretsPreservingKey() {
        ...
        assertThat(result.text()).contains("password=" + TOKEN);
    ...
    void redactsConnectionStrings() {
        ...
        assertThat(result.text()).doesNotContain("pass@db.internal");
    ...
    void redactsIpAddresses() {
        ...
        assertThat(result.text()).isEqualTo("client " + TOKEN + " connected");
